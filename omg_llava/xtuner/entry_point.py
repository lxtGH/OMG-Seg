...
MODES = ('list-cfg', 'copy-cfg', 'log-dataset', 'check-custom-dataset',
         ...
         'eval_refcoco', 'mmbench_omg_seg_llava', 'gcg_omg_seg_llava',
         'refcoco_omg_seg_llava',
         'region_cap_mask_omg_seg_llava', )
...
def gcg_omg_seg_llava():
    from omg_llava.tools import gcg_omg_seg_llava
    return gcg_omg_seg_llava.__file__
...
modes = {
    ...
    'gcg_omg_seg_llava': gcg_omg_seg_llava,
...
MAP_FILE_FUNCS = [
    ...
    mmbench_omg_seg_llava, gcg_omg_seg_llava, refcoco_omg_seg_llava,
    region_cap_mask_omg_seg_llava,
]
